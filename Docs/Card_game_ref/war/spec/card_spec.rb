...
describe Card do
  ...
  describe '#initialize' do
    it "detects bad initialization arguments" do
      expect { Card.new(nil, nil) }.to raise_error "invalid suit or value"
      expect { Card.new(:fake_suit, :three) }.to raise_error "invalid suit or value"
      expect { Card.new(:clubs, :shfifteen_teen) }.to raise_error "invalid suit or value"
    end
